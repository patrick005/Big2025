...
/*
stack3은
array파일에서 헤더랑 array.o들고오고
stack2에서 main.cpp main.o stack.cpp stack.o stack.h 들고와야함
거기서  stack.cpp와 stack.h 만 수정해서 컴파일함

~/Big2025/cpp/stack3$ g++ -o testStack  main.o stack.o array.o
~/Big2025/cpp/stack3$ ./testStack 
main.cpp 추가로 컴파일하려고 시도하면 오류남
  ** stack.h:13:9: error: ‘Array’ does not name a type **
stack2에서 컴파일한거 들고와야함
